...
/**
 * Base class that represents a row from the 'memberprofile' table.
 *
 *
 *
...
abstract class BasememberProfile extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'memberProfilePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        memberProfilePeer
     */
    ...
    /**
     * Initializes internal state of BasememberProfile object.
     * @see        applyDefaults()
     */
     ...
     * @return memberProfile The current object (for fluent API support)
     */
    ...
    public function setVisible($v)
    {
        ...
        if ($this->visible !== $v) {
            $this->visible = $v;
            $this->modifiedColumns[] = memberProfilePeer::VISIBLE;
        }
    ...
    public function setBio($v)
    {
        ...
        if ($this->bio !== $v) {
            $this->bio = $v;
            $this->modifiedColumns[] = memberProfilePeer::BIO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = memberProfilePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = memberProfilePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = memberProfileQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                memberProfilePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(memberProfilePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(memberProfilePeer::VISIBLE)) {
            $modifiedColumns[':p' . $index++]  = '`visible`';
        }
        if ($this->isColumnModified(memberProfilePeer::BIO)) {
            $modifiedColumns[':p' . $index++]  = '`bio`';
        }

        $sql = sprintf(
            'INSERT INTO `memberprofile` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(memberProfilePeer::VISIBLE)) $criteria->add(memberProfilePeer::VISIBLE, $this->visible);
        if ($this->isColumnModified(memberProfilePeer::BIO)) $criteria->add(memberProfilePeer::BIO, $this->bio);
     ...
     * objects.
     *
     * @param object $copyObj An object of memberProfile (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return memberProfile Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->id !== null) && $doQuery) {
            ...
            $this->aUser->setmemberProfile($this);
        }
    ...
    {
        return (string) $this->exportTo(memberProfilePeer::DEFAULT_STRING_FORMAT);
    }
