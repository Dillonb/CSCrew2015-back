...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Netid', 'Name', 'Picture', 'Year', 'IsAdmin', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'netid', 'name', 'picture', 'year', 'isAdmin', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::NETID, UserPeer::NAME, UserPeer::PICTURE, UserPeer::YEAR, UserPeer::IS_ADMIN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NETID', 'NAME', 'PICTURE', 'YEAR', 'IS_ADMIN', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'netid', 'name', 'picture', 'year', 'is_admin', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Netid' => 1, 'Name' => 2, 'Picture' => 3, 'Year' => 4, 'IsAdmin' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'netid' => 1, 'name' => 2, 'picture' => 3, 'year' => 4, 'isAdmin' => 5, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::NETID => 1, UserPeer::NAME => 2, UserPeer::PICTURE => 3, UserPeer::YEAR => 4, UserPeer::IS_ADMIN => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NETID' => 1, 'NAME' => 2, 'PICTURE' => 3, 'YEAR' => 4, 'IS_ADMIN' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'netid' => 1, 'name' => 2, 'picture' => 3, 'year' => 4, 'is_admin' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
